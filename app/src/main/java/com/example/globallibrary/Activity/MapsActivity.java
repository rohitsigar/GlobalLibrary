                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (document.exists()) {
                              ...
                              GeoPoint location1 = document.getGeoPoint("Longitude");
                              Location location2 = new Location("");
                              location2.setLongitude(location1.getLongitude());
                              location2.setLatitude(location1.getLatitude());
                              Toast.makeText(MapsActivity.this  , String.valueOf(location2.distanceTo(location)), Toast.LENGTH_SHORT).show();
